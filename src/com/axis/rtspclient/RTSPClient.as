package com.axis.rtspclient {
  ...
  public class RTSPClient extends NetStreamClient implements IClient {
      ...
      private function onRTSPCommand():void {
          ...
          Logger.log('RTSP IN: ', parsed.code);
          ...
          switch (state) {
              ...
              case STATE_PLAY:
                  ...
                  this.addEventListener("AUDIO_PCMU_PACKET", apcmu.onRTPPacket);
                  ...
                  apcmu.addEventListener(PCMUFrame.NEW_FRAME, flvmux.onPCMUFrame);
                  break;
      ...
      private function sendOptionsReq():void {
          ...
          var req:String =
              ...
              "\r\n";
          Logger.log('RTSP OUT: OPTIONS'); //, req);
      ...
      private function sendDescribeReq():void {
          ...
          var req:String =
              ...
              "\r\n";
          Logger.log('RTSP OUT: DESCRIBE'); //, req);
          handle.writeUTFBytes(req);
      ...
      private function sendTeardownReq():void {
          ...
          var req:String =
              ...
              "\r\n";
          Logger.log('RTSP OUT: TEARDOWN'); //, req);
          handle.writeUTFBytes(req);
      ...
      private function sendGetParamReq(): void {
          ...
          Logger.log('RTSP OUT: GET_PARAMETER'); //, req);
          handle.writeUTFBytes(req);
      }
